...
# PROTOTYPE VIER - AFRIKAANS GEÏNSPIREERDE KUNST
...
def draw():
    ...
    code = {
        ...
        'r': ['vorm 3', 70, secundair_3],
        's': ['vorm 1', 36, primair_4],
        't': ['vorm 2', 74, primair_1],
        'u': ['vorm 3', 58, primair_3],
        'v': ['vorm 2', 78, primair_1],
        'w': ['vorm 1', 24, secundair_3],
        'x': ['vorm 3', 14, primair_4],
        'y': ['vorm 1', 67, secundair_2],
        'z': ['vorm 2', 70, complementair_2],
        ' ': ['vorm 3', 25, complementair_1],
        '?': ['vorm 2', 54, secundair_2],
        '!': ['vorm 3', 37, primair_4],
        '#': ['vorm 2', 76, secundair_1],
        '@': ['vorm 1', 24, primair_3],
        '£': ['vorm 3', 83, secundair_2],
        '$': ['vorm 1', 72, secundair_3],
        ':': ['vorm 2', 54, primair_1],
        '&': ['vorm 3', 63, secundair_2],
        '*': ['vorm 2', 14, secundair_3],
        '+': ['vorm 1', 39, secundair_1],
        '=': ['vorm 3', 75, primair_4],
        '-': ['vorm 1', 79, secundair_2],
        '~': ['vorm 2', 38, complementair_2],
        '/': ['vorm 3', 25, complementair_1],
